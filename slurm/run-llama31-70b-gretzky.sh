#!/usr/bin/env bash
#SBATCH --job-name=acr-llama31-70b-gretzky
#SBATCH --output=acr-llama31-70b-gretzky.log
#SBATCH --error=acr-llama31-70b-gretzky.err
...
# famous_quotes idx 52 (Gretzky): "You miss 100% of the shots you don't take."
