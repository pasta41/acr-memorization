#!/usr/bin/env bash
#SBATCH --job-name=acr-llama31-8b-cq4
#SBATCH --output=acr-llama31-8b-cq4.log
#SBATCH --error=acr-llama31-8b-cq4.err
...
# Probabilistic ACR (success = P(suffix|prompt) >= b**T), scan n=5..T-1, on Llama-3.1-8B base.  Gated on HF (Llama token).
